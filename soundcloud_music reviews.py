...
result, _ = reviews(
    'com.google.android.soundcloud.music',  
    lang='id',
    country='id',
    count=1000
)
...
df[['content', 'score']].to_csv('soundcloud.music_reviews.csv', index=False)
import re
...
df = pd.read_csv('soundcloud.music_reviews.csv')
...
plt.title("Distribusi Sentimen Ulasan soundcloud.music")
plt.xlabel("Sentimen")
